      ...
      <div class="container">
        <div class="row align-items-center justify-content-start">
          <div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400">
            <h1 class="bg-text-line">Fixed Matches 100% Sure</h1>
            <p class="mt-4">Welcome, Now you will see something interesting, making money in a fun way!

Let us help you before considering our site, you want Fixed Matches 100% sure to make sure profit without risk or you are just on our site to Get <strong style="color:green;">Free Daily Predictions?</strong> Here below you need to choose what you want:</p>
          </div>
        </div>
      </div>
    </div>
